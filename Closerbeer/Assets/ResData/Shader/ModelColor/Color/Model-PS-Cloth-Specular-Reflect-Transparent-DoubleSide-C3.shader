...
Shader "ModelColor/Color/Transparent Cutoff - 3/PS - Cloth Specular Reflect Double Side - C3" {
Properties {
...
Fallback "Hidden/LightProbes Transparent Double Side - C3"
}
