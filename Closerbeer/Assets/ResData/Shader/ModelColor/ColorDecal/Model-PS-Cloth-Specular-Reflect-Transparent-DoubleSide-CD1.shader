...
Shader "ModelColor/ColorDecal/Transparent Cutoff - 1/PS - Cloth Specular Reflect Double Side - CD1" {
Properties {
...
Fallback "Hidden/LightProbes Transparent Double Side - CD1"
}
