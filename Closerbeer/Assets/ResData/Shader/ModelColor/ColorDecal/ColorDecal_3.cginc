#ifndef	COLORDECAL_INCLUDED_3
#define	COLORDECAL_INCLUDED_3
...
#define	COLOR_DECAL_VERT \
	...
	o.decal12.zw = v.texcoord.xy * _Decal2_ST.xy * 7.5;
...
#define	COLOR_DECAL_PS_OPAQUE \
	...
	fixed4	decal2	= tex2D(_Decal2, i.decal12.zw); \
								\
	...
	c.rgb = lerp(c.rgb, col0, _ModelColor0.a) * maskcd.r +   \
			...
			lerp(c.rgb, col2, _ModelColor2.a) * maskcd.b +  \
			c.rgb * c_alpha;  \
										\
	c.rgb = (lerp(c.rgb, decal0.rgb * max(1.0, _DecalBrightness.x), min(1.0, _DecalBrightness.x * decal0.a)) * maskcd.r +  \
			lerp(c.rgb, decal1.rgb * max(1.0, _DecalBrightness.y), min(1.0, _DecalBrightness.y * decal1.a)) * maskcd.g +  \
			lerp(c.rgb, decal2.rgb * max(1.0, _DecalBrightness.z), min(1.0, _DecalBrightness.z * decal2.a)) * maskcd.b) * _ColorBrightness +  \
			c.rgb * c_alpha; \
