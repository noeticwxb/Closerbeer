Shader "MADFINGER/FX/Anim texture(Transparent)" {
Properties {
...
SubShader {
	...
	Pass {
		...
		{
			fixed4 col = lerp(tex2D (_MainTex, i.uv.xy),tex2D (_MainTex, i.uv.zw),i.col.a) * i.col; 
			
#ifdef LIGHTMAP_ON
             col.rgb *= DecodeLightmap(tex2D(unity_Lightmap, i.uvlm));
 #endif
